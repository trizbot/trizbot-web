...
export const SUPPORTED_FIAT: string[] = [
  ...
  'AFN', 'ALL', 'DZD', 'AOA', 'XCD', 'ARS', 'AMD', 'AWG', 'AZN', 'BSD',
  'BHD', 'BDT', 'BBD', 'BYN', 'BZD', 'BMD', 'BTN', 'BOB', 'BAM', 'BWP',
  'BND', 'BGN', 'BIF', 'KHR', 'XAF', 'CVE', 'KYD', 'CLP', 'COP', 'KMF',
  'CDF', 'CRC', 'HRK', 'CUP', 'ANG', 'CZK', 'DKK', 'DJF', 'DOP', 'ERN',
  'ETB', 'FJD', 'XPF', 'GMD', 'GEL', 'GIP', 'GTQ', 'GNF', 'GYD', 'HTG',
  'HNL', 'HKD', 'HUF', 'ISK', 'IDR', 'IRR', 'IQD', 'ILS', 'JMD', 'JOD',
  'KZT', 'KPW', 'KRW', 'KWD', 'KGS', 'LAK', 'LBP', 'LSL', 'LRD', 'LYD',
  'CHF', 'MOP', 'MKD', 'MGA', 'MWK', 'MYR', 'MVR', 'MRU', 'MUR', 'MXN',
  'MDL', 'MNT', 'MAD', 'MZN', 'MMK', 'NAD', 'NPR', 'NOK', 'NZD', 'NIO',
  'OMR', 'PAB', 'PGK', 'PYG', 'PEN', 'PHP', 'PLN', 'QAR', 'RON', 'RUB',
  'RWF', 'WST', 'SAR', 'RSD', 'SCR', 'SLE', 'SGD', 'SBD', 'SOS', 'SSP',
  'LKR', 'SDG', 'SRD', 'SEK', 'SYP', 'TWD', 'TJS', 'THB', 'TOP', 'TTD',
  'TND', 'TMT', 'UAH', 'UYU', 'UZS', 'VUV', 'VES', 'VND', 'YER', 'ZMW',
  'ZWL',
];
...
export const PAYMENT_METHODS_BY_FIAT: Record<string, string[]> = {
  ...
  ZAR: ['Solidpyco', 'Bank Transfer (EFT)', 'Capitec Pay', 'FNB eWallet'],
  INR: ['Solidpyco', 'UPI', 'IMPS', 'Paytm', 'Bank Transfer'],
  CNY: ['Solidpyco', 'Alipay', 'WeChat Pay', 'Bank Transfer'],
  AED: ['Solidpyco', 'Bank Transfer', 'Wise'],
  CAD: ['Solidpyco', 'Interac e-Transfer', 'Wise'],
  AUD: ['Solidpyco', 'PayID', 'Bank Transfer', 'Wise'],
  JPY: ['Solidpyco', 'Bank Transfer', 'PayPay'],
  BRL: ['Solidpyco', 'Pix', 'Bank Transfer'],
  TRY: ['Solidpyco', 'Papara', 'Bank Transfer', 'Wise'],
  PKR: ['Solidpyco', 'Easypaisa', 'JazzCash', 'Bank Transfer'],
  ...
  AFN: ['Solidpyco', 'Bank Transfer', 'Hawala'],
  ALL: ['Solidpyco', 'Bank Transfer', 'Wise'],
  DZD: ['Solidpyco', 'Bank Transfer'],
  AOA: ['Solidpyco', 'Bank Transfer', 'Multicaixa Express'],
  XCD: ['Solidpyco', 'Bank Transfer', 'Wise'],
  ARS: ['Solidpyco', 'Bank Transfer', 'Mercado Pago'],
  AMD: ['Solidpyco', 'Bank Transfer', 'Idram'],
  AWG: ['Solidpyco', 'Bank Transfer'],
  AZN: ['Solidpyco', 'Bank Transfer', 'M10'],
  BSD: ['Solidpyco', 'Bank Transfer'],
  BHD: ['Solidpyco', 'Bank Transfer', 'BenefitPay'],
  BDT: ['Solidpyco', 'bKash', 'Nagad', 'Bank Transfer'],
  BBD: ['Solidpyco', 'Bank Transfer'],
  BYN: ['Solidpyco', 'Bank Transfer', 'ERIP'],
  BZD: ['Solidpyco', 'Bank Transfer'],
  BMD: ['Solidpyco', 'Bank Transfer'],
  BTN: ['Solidpyco', 'Bank Transfer'],
  BOB: ['Solidpyco', 'Bank Transfer'],
  BAM: ['Solidpyco', 'Bank Transfer'],
  BWP: ['Solidpyco', 'Bank Transfer', 'Orange Money'],
  BND: ['Solidpyco', 'Bank Transfer'],
  BGN: ['Solidpyco', 'Bank Transfer', 'Wise'],
  BIF: ['Solidpyco', 'Bank Transfer', 'Lumicash'],
  KHR: ['Solidpyco', 'Bank Transfer', 'Wing', 'ABA Mobile'],
  XAF: ['Solidpyco', 'Orange Money', 'MTN Mobile Money', 'Bank Transfer'],
  CVE: ['Solidpyco', 'Bank Transfer'],
  KYD: ['Solidpyco', 'Bank Transfer'],
  CLP: ['Solidpyco', 'Bank Transfer'],
  COP: ['Solidpyco', 'Bank Transfer', 'Nequi'],
  KMF: ['Solidpyco', 'Bank Transfer'],
  CDF: ['Solidpyco', 'Bank Transfer', 'Orange Money', 'M-Pesa'],
  CRC: ['Solidpyco', 'Bank Transfer', 'SINPE Movil'],
  HRK: ['Solidpyco', 'Bank Transfer'],
  CUP: ['Solidpyco', 'Bank Transfer'],
  ANG: ['Solidpyco', 'Bank Transfer'],
  CZK: ['Solidpyco', 'Bank Transfer', 'Wise'],
  DKK: ['Solidpyco', 'Bank Transfer', 'MobilePay', 'Wise'],
  DJF: ['Solidpyco', 'Bank Transfer'],
  DOP: ['Solidpyco', 'Bank Transfer'],
  ERN: ['Solidpyco', 'Bank Transfer'],
  ETB: ['Solidpyco', 'Bank Transfer', 'Telebirr'],
  FJD: ['Solidpyco', 'Bank Transfer'],
  XPF: ['Solidpyco', 'Bank Transfer'],
  GMD: ['Solidpyco', 'Bank Transfer', 'Wave'],
  GEL: ['Solidpyco', 'Bank Transfer', 'TBC Pay'],
  GIP: ['Solidpyco', 'Bank Transfer'],
  GTQ: ['Solidpyco', 'Bank Transfer'],
  GNF: ['Solidpyco', 'Bank Transfer', 'Orange Money'],
  GYD: ['Solidpyco', 'Bank Transfer'],
  HTG: ['Solidpyco', 'Bank Transfer', 'MonCash'],
  HNL: ['Solidpyco', 'Bank Transfer'],
  HKD: ['Solidpyco', 'Bank Transfer', 'FPS', 'PayMe'],
  HUF: ['Solidpyco', 'Bank Transfer', 'Wise'],
  ISK: ['Solidpyco', 'Bank Transfer'],
  IDR: ['Solidpyco', 'Bank Transfer', 'GoPay', 'OVO', 'DANA'],
  IRR: ['Solidpyco', 'Bank Transfer'],
  IQD: ['Solidpyco', 'Bank Transfer'],
  ILS: ['Solidpyco', 'Bank Transfer', 'Bit'],
  JMD: ['Solidpyco', 'Bank Transfer'],
  JOD: ['Solidpyco', 'Bank Transfer'],
  KZT: ['Solidpyco', 'Bank Transfer', 'Kaspi Pay'],
  KPW: ['Solidpyco', 'Bank Transfer'],
  KRW: ['Solidpyco', 'Bank Transfer', 'KakaoPay', 'Toss'],
  KWD: ['Solidpyco', 'Bank Transfer', 'KNET'],
  KGS: ['Solidpyco', 'Bank Transfer'],
  LAK: ['Solidpyco', 'Bank Transfer'],
  LBP: ['Solidpyco', 'Bank Transfer'],
  LSL: ['Solidpyco', 'Bank Transfer'],
  LRD: ['Solidpyco', 'Bank Transfer', 'Orange Money'],
  LYD: ['Solidpyco', 'Bank Transfer'],
  CHF: ['Solidpyco', 'Bank Transfer', 'TWINT', 'Wise'],
  MOP: ['Solidpyco', 'Bank Transfer'],
  MKD: ['Solidpyco', 'Bank Transfer'],
  MGA: ['Solidpyco', 'Bank Transfer', 'Orange Money', 'Mvola'],
  MWK: ['Solidpyco', 'Bank Transfer', 'Airtel Money'],
  MYR: ['Solidpyco', 'Bank Transfer', 'DuitNow', 'Touch', 'n Go eWallet'],
  MVR: ['Solidpyco', 'Bank Transfer'],
  MRU: ['Solidpyco', 'Bank Transfer'],
  MUR: ['Solidpyco', 'Bank Transfer', 'MyT Money'],
  MXN: ['Solidpyco', 'Bank Transfer', 'SPEI', 'Wise'],
  MDL: ['Solidpyco', 'Bank Transfer'],
  MNT: ['Solidpyco', 'Bank Transfer'],
  MAD: ['Solidpyco', 'Bank Transfer'],
  MZN: ['Solidpyco', 'Bank Transfer', 'M-Pesa'],
  MMK: ['Solidpyco', 'Bank Transfer', 'KBZPay'],
  NAD: ['Solidpyco', 'Bank Transfer'],
  NPR: ['Solidpyco', 'Bank Transfer', 'eSewa', 'Khalti'],
  NOK: ['Solidpyco', 'Bank Transfer', 'Vipps', 'Wise'],
  NZD: ['Solidpyco', 'Bank Transfer', 'Wise'],
  NIO: ['Solidpyco', 'Bank Transfer'],
  OMR: ['Solidpyco', 'Bank Transfer'],
  PAB: ['Solidpyco', 'Bank Transfer'],
  PGK: ['Solidpyco', 'Bank Transfer'],
  PYG: ['Solidpyco', 'Bank Transfer'],
  PEN: ['Solidpyco', 'Bank Transfer', 'Yape', 'Plin'],
  PHP: ['Solidpyco', 'Bank Transfer', 'GCash', 'Maya'],
  PLN: ['Solidpyco', 'Bank Transfer', 'BLIK', 'Wise'],
  QAR: ['Solidpyco', 'Bank Transfer'],
  RON: ['Solidpyco', 'Bank Transfer', 'Wise'],
  RUB: ['Solidpyco', 'Bank Transfer', 'SBP'],
  RWF: ['Solidpyco', 'Bank Transfer', 'MTN Mobile Money', 'Airtel Money'],
  WST: ['Solidpyco', 'Bank Transfer'],
  SAR: ['Solidpyco', 'Bank Transfer', 'STC Pay'],
  RSD: ['Solidpyco', 'Bank Transfer'],
  SCR: ['Solidpyco', 'Bank Transfer'],
  SLE: ['Solidpyco', 'Bank Transfer', 'Orange Money'],
  SGD: ['Solidpyco', 'Bank Transfer', 'PayNow', 'Wise'],
  SBD: ['Solidpyco', 'Bank Transfer'],
  SOS: ['Solidpyco', 'Bank Transfer', 'EVC Plus'],
  SSP: ['Solidpyco', 'Bank Transfer'],
  LKR: ['Solidpyco', 'Bank Transfer'],
  SDG: ['Solidpyco', 'Bank Transfer'],
  SRD: ['Solidpyco', 'Bank Transfer'],
  SEK: ['Solidpyco', 'Bank Transfer', 'Swish', 'Wise'],
  SYP: ['Solidpyco', 'Bank Transfer'],
  TWD: ['Solidpyco', 'Bank Transfer'],
  TJS: ['Solidpyco', 'Bank Transfer'],
  THB: ['Solidpyco', 'Bank Transfer', 'PromptPay', 'TrueMoney'],
  TOP: ['Solidpyco', 'Bank Transfer'],
  TTD: ['Solidpyco', 'Bank Transfer'],
  TND: ['Solidpyco', 'Bank Transfer'],
  TMT: ['Solidpyco', 'Bank Transfer'],
  UAH: ['Solidpyco', 'Bank Transfer', 'Monobank'],
  UYU: ['Solidpyco', 'Bank Transfer'],
  UZS: ['Solidpyco', 'Bank Transfer', 'Payme'],
  VUV: ['Solidpyco', 'Bank Transfer'],
  VES: ['Solidpyco', 'Bank Transfer', 'Pago Movil'],
  VND: ['Solidpyco', 'Bank Transfer', 'MoMo', 'ZaloPay'],
  YER: ['Solidpyco', 'Bank Transfer'],
  ZMW: ['Solidpyco', 'Bank Transfer', 'Airtel Money', 'MTN Mobile Money'],
  ZWL: ['Solidpyco', 'Bank Transfer', 'EcoCash'],
};
